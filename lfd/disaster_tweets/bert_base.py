...
class Roberta(nn.Module):
    def __init__(self):
        super().__init__()
        self.backbone = AutoModel.from_pretrained("/Users/heyao/Desktop/roberta-base")
...
if __name__ == '__main__':
    ...
    dataset = DisasterTweetsBertDataset(X_train["text"].to_list(), y_train, tokenizer)
    # lengths = []
    ...
    val_dataset = DisasterTweetsBertDataset(X_val["text"].to_list(), y_val, tokenizer)
